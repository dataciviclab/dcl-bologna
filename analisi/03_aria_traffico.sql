...
-- Dataset: centraline-aria, varco-ercolani
-- Richiede: make fetch/centraline-aria, make fetch/varco-ercolani
-- ============================================================
...
JOIN read_parquet('_data/varco-ercolani.parquet') v ON a.reftime = v.data
