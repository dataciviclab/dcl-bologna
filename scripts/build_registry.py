...
- GCS: non ancora attivo (prefix vuoto) — il registry documenta i dataset locali.
...
def main() -> int:
    ...
    layout = RepoLayout(
        ...
        source_repo="dataciviclab/dcl-bologna",
    )
    # GCS non attivo: prefix vuoto, layout con anno (come dataset-incubator)
    contract = PathContract(prefix="", clean_layout="year", mart_layout="year")
